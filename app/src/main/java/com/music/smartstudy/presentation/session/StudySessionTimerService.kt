...
import com.music.smartstudy.util.Constants.NOTIFICATION_CHANNEL_ID
import com.music.smartstudy.util.Constants.NOTIFICATION_CHANNEL_NAME
import com.music.smartstudy.util.Constants.NOTIFICATION_ID
import com.music.smartstudy.util.pad
...
class StudySessionTimerService : Service() {
    ...
    var hours = mutableStateOf("00")
        private set
    var currentTimerState = mutableStateOf(TimerStart.IDLE)
        private set
    ...
    private fun startTimer(
        ...
        currentTimerState.value = TimerStart.STARTED
    ...
    private fun stopTimer() {
        ...
        currentTimerState.value = TimerStart.STOPPED
    }

    private fun cancelTimer() {
        duration = Duration.ZERO
        updateTimeUnits()
        currentTimerState.value = TimerStart.IDLE
    }
